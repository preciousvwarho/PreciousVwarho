     ...
     <Head>
      ...
      <section className="section-default sec-one">  
             ...
             <div className="row">
                ...
                <div className="col-lg-7 col-md-5">
                  <div className="row justify-content-center">
                      <img src={`./images/presh.jpg`} width="250" className="d-inline-block prof-img wow fadeInUp" data-wow-duration="1s" data-wow-delay="1s" alt=""/> 
        ...
        <div className="portfolio portfolio-right">
              <div className="row">
                  <div className="col-md-9 project-image text-center border-right wow fadeInLeft" data-wow-duration="0.5s" data-wow-delay="1s" >
                      <img src={`./images/Enteroui.png`} className="d-inline-block img-fluid" alt=""/> 
                    </div>
                  <div className="col-md-3">
                     <div className="prof-text-energie wow fadeInRight" data-wow-duration="1s" data-wow-delay="1.5s">
                        <h3 className="wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.5s">Entero Homes</h3>
                        <span className="project-stack"><span>Front-end Developer&nbsp; • &nbsp;</span><span>UI Designer</span></span>
                        <p className="page-p">Entero Homes is one of the fastest growing real estate companies is Nigeria.</p>
                            <a target="_blank" rel="noopener noreferrer" className="view-btn" href="https://www.enterohomes.com" >view project</a>
                     </div>
                  </div>
               </div>
             </div>
             ...
             <div className="portfolio portfolio-left">
              <div className="row">
                  <div className="col-md-9  order-md-last project-image border-l wow fadeInRight" data-wow-duration="0.5s" data-wow-delay="1s">
                      <img src={`./images/fortis-mobile.png`} className="d-inline-block img-fluid" data-wow-duration="1s" data-wow-delay="1s" alt=""/> 
                    </div>
                  <div className="col-md-3">
                     <div className="prof-text wow fadeInLeft" data-wow-duration="1s" data-wow-delay="1.5s">
                          <h3>Fortis Pay</h3>
                          <span className="project-stack"><span>Mobile App Developer</span></span>
                            <p className="page-p">Fortis is a Fin-tech application that helps you perform seemless transactions including bill payment and others.</p>
                            <a target="_blank" rel="noopener noreferrer" className="view-btn" href="https://play.google.com/store/apps/details?id=com.fortismoney.fortismobile&hl=en_US" >view project</a>
        ...
        <div className="portfolio portfolio-right">
              <div className="row">
                  <div className="col-md-9 project-image text-center border-right wow fadeInLeft" data-wow-duration="0.5s" data-wow-delay="1s" >
                      <img src={`./images/div.png`} className="d-inline-block img-fluid" alt=""/> 
                    </div>
                  <div className="col-md-3">
                     <div className="prof-text-energie wow fadeInRight" data-wow-duration="1s" data-wow-delay="1.5s">
                        <h3 className="wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.5s">Divs Global</h3>
                        <span className="project-stack"><span>Front-end Developer&nbsp; • &nbsp;</span><span>UI Designer</span></span>
                        <p className="page-p">Divs global specializes in environment and safety solutions, civil works, mechanical works, metal fabrication, general procurement, and consultancy services</p>
                            <a target="_blank" rel="noopener noreferrer" className="view-btn" href="https://divsglobal.com" >view project</a>
                     </div>
                  </div>
              </div>
             </div>
                  ...
                  <div className="col-md-3">
                     <div className="prof-text wow fadeInLeft" data-wow-duration="1s" data-wow-delay="1.5s">
                        ...
                        <span className="project-stack"><span>Front-end Developer&nbsp; • &nbsp;</span><span>UI Designer</span></span>
                            ...
                            <a target="_blank" rel="noopener noreferrer" className="view-btn" href="https://blano-global.vercel.app" >view project</a>
                      </div>
                  </div>
              </div>
             </div>
            ...
            <div className="portfolio portfolio-right">
              <div className="row">
                  <div className="col-md-9 project-image text-center border-right wow fadeInLeft" data-wow-duration="0.5s" data-wow-delay="1s" >
                      <img src={`./images/enteroapp.png`} className="d-inline-block img-fluid" alt=""/> 
                    </div>
                  <div className="col-md-3">
                     <div className="prof-text-energie wow fadeInRight" data-wow-duration="1s" data-wow-delay="1.5s">
          ...
          <div className="portfolio portfolio-left">
              <div className="row">
                  <div className="col-md-9  order-md-last project-image border-l wow fadeInRight" data-wow-duration="0.5s" data-wow-delay="1s">
                      <img src={`./images/WorkTwo.png`} className="d-inline-block img-fluid" data-wow-duration="1s" data-wow-delay="1s" alt=""/> 
                    </div>
                  <div className="col-md-3">
                     <div className="prof-text wow fadeInLeft" data-wow-duration="1s" data-wow-delay="1.5s">
                          <h3>Elroi Mobile</h3>
                          <span className="project-stack"><span>Front-end Developer&nbsp; • &nbsp;</span><span>UI Designer</span></span>
                            <p className="page-p">Elroi is a video conference application that helps users connect to host and their materials real time</p>
                            <a  className="view-btn" href="#" >Coming soon</a>
          ...
          <div className="container">
             ...
             <div className="social wow fadeInUp" data-wow-duration="1s" data-wow-delay="2s">
               <ul>
                 ...
                 <li>
                   <a href="https://x.com/preciousvwarho">
             ...
             <div className="copywrite wow fadeInUp" data-wow-duration="1s" data-wow-delay="2s">
                  <a href="http://">© 2023 preciousvwarho</a>
               </div>
